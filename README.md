...
- Tab / window switch detection using Browser Visibility API
- Auto-submission after multiple violations
- Right-click disabled
- Copy / paste / text selection disabled
  
**Server-Side Validation**

- Exam start time stored securely in session
- Submission time validated on backend
- Prevents manipulation of client-side timers
...
- Helps identify exam difficulty
